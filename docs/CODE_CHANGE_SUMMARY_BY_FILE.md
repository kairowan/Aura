...
### 2. `backend/packages/harness/aura/agents/lead_agent/prompt.py`
...
### 4. `backend/packages/harness/aura/subagents/builtins/general_purpose.py`
...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_aura_20260201.md`
