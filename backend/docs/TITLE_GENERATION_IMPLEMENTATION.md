...
#### [`packages/harness/aura/agents/thread_state.py`](../packages/harness/aura/agents/thread_state.py)
- ✅ 添加 `title: str | None = None` 字段到 `ThreadState`

#### [`packages/harness/aura/config/title_config.py`](../packages/harness/aura/config/title_config.py) (新建)
- ✅ 创建 `TitleConfig` 配置类
...
#### [`packages/harness/aura/agents/title_middleware.py`](../packages/harness/aura/agents/title_middleware.py) (新建)
...
#### [`packages/harness/aura/config/app_config.py`](../packages/harness/aura/config/app_config.py)
- ✅ 导入 `load_title_config_from_dict`
- ✅ 在 `from_file()` 中加载 title 配置

#### [`packages/harness/aura/agents/lead_agent/agent.py`](../packages/harness/aura/agents/lead_agent/agent.py)
- ✅ 导入 `TitleMiddleware`
