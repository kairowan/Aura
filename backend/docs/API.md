...
This document provides a complete reference for the Aura backend APIs.

## Overview

Aura backend exposes two sets of APIs:
  ...
  "files": [
    {
      ...
      "size": 1234567,
      "path": ".aura/threads/abc123/user-data/uploads/document.pdf",
      "virtual_path": "/mnt/user-data/uploads/document.pdf",
      "artifact_url": "/api/threads/abc123/artifacts/mnt/user-data/uploads/document.pdf",
      "markdown_file": "document.md",
      "markdown_path": ".aura/threads/abc123/user-data/uploads/document.md",
...
Remove Aura-managed local thread files under `.aura/threads/{thread_id}` after the LangGraph thread itself has been deleted.
...
Currently, Aura does not implement authentication. All APIs are accessible without credentials.

Note: This is about Aura API authentication. MCP outbound connections can still use OAuth for configured HTTP/SSE MCP servers.
