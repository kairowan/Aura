...
{
  "graphs": {
    "lead_agent": "aura.agents:lead_agent"
  },
...
```python
from aura.config.title_config import TitleConfig, set_title_config
...
# 测试 title 生成
import pytest
from aura.agents.title_middleware import TitleMiddleware
...
- [`packages/harness/aura/agents/thread_state.py`](../packages/harness/aura/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/aura/agents/title_middleware.py`](../packages/harness/aura/agents/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/aura/config/title_config.py`](../packages/harness/aura/config/title_config.py) - 配置管理
- [`config.yaml`](../config.yaml) - 配置文件
- [`packages/harness/aura/agents/lead_agent/agent.py`](../packages/harness/aura/agents/lead_agent/agent.py) - Middleware 注册
