...
from aura.mcp.client import build_servers_config
from aura.mcp.oauth import build_oauth_tool_interceptor, get_initial_oauth_headers
...
async def get_mcp_tools() -> list[BaseTool]:
    ...
    try:
        ...
        # Patch tools to support sync invocation, as aura client streams synchronously
        for tool in tools:
