...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: aura-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. aura.sandbox.local:LocalSandboxProvider)",
    )
