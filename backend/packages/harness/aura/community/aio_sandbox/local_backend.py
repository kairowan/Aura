...
from aura.utils.network import get_free_port, release_port
...
class LocalContainerBackend(SandboxBackend):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            container_prefix: Prefix for container names (e.g., "aura-sandbox").
    ...
    def create(self, thread_id: str, sandbox_id: str, extra_mounts: list[tuple[str, str, bool]] | None = None) -> SandboxInfo:
        ...
        sandbox_host = os.environ.get("AURA_SANDBOX_HOST", "localhost")
        return SandboxInfo(
