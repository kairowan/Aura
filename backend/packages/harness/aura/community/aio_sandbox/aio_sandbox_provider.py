...
from aura.config.paths import VIRTUAL_PATH_PREFIX, Paths, get_paths
from aura.sandbox.sandbox import Sandbox
from aura.sandbox.sandbox_provider import SandboxProvider
...
DEFAULT_PORT = 8080
DEFAULT_CONTAINER_PREFIX = "aura-sandbox"
...
class AioSandboxProvider(SandboxProvider):
    ...
    def _get_thread_mounts(thread_id: str) -> list[tuple[str, str, bool]]:
        ...
        # host_paths resolves to the host-side base dir when AURA_HOST_BASE_DIR
    ...
    def _get_skills_mount() -> tuple[str, str, bool] | None:
        ...
        Mount source uses AURA_HOST_SKILLS_PATH when running inside Docker (DooD)
        ...
        try:
            ...
            if skills_path.exists():
                ...
                host_skills = os.environ.get("AURA_HOST_SKILLS_PATH") or str(skills_path)
