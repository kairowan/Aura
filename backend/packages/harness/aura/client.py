"""AuraClient — Embedded Python client for Aura agent system.

Provides direct programmatic access to Aura's agent capabilities
...
from aura.agents.lead_agent.agent import _build_middlewares
from aura.agents.lead_agent.prompt import apply_prompt_template
from aura.agents.thread_state import ThreadState
from aura.config.agents_config import AGENT_NAME_PATTERN
from aura.config.app_config import get_app_config, reload_app_config
from aura.config.extensions_config import ExtensionsConfig, SkillStateConfig, get_extensions_config, reload_extensions_config
from aura.config.paths import get_paths
from aura.models import create_chat_model
from aura.skills.installer import install_skill_from_archive
from aura.uploads.manager import (
...
class AuraClient:
    """Embedded Python client for Aura agent system.
    ...
    def _ensure_agent(self, config: RunnableConfig):
        ...
        if checkpointer is None:
            from aura.agents.checkpointer import get_checkpointer
    ...
    def _serialize_message(msg) -> dict:
        ...
        if isinstance(msg, ToolMessage):
            return {
                "type": "tool",
                "content": AuraClient._extract_text(msg.content),
    ...
    def list_skills(self, enabled_only: bool = False) -> dict:
        ...
        """
        from aura.skills.loader import load_skills
    ...
    def update_mcp_config(self, mcp_servers: dict[str, dict]) -> dict:
        ...
        if config_path is None:
            raise FileNotFoundError("Cannot locate extensions_config.json. Set AURA_EXTENSIONS_CONFIG_PATH or ensure it exists in the project root.")
    ...
    def reload_memory(self) -> dict:
        ...
        """
        from aura.agents.memory.updater import reload_memory_data
    ...
    def get_memory_config(self) -> dict:
        ...
        Returns:
            Memory config dict.
        """
        from aura.config.memory_config import get_memory_config
    ...
    def upload_files(self, thread_id: str, files: list[str | Path]) -> dict:
        ...
        """
        from aura.utils.file_conversion import CONVERTIBLE_EXTENSIONS, convert_file_to_markdown
    ...
    def delete_upload(self, thread_id: str, filename: str) -> dict:
        ...
        """
        from aura.utils.file_conversion import CONVERTIBLE_EXTENSIONS
