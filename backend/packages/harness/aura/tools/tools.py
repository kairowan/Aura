...
def get_available_tools(
    ...
    `initialize_mcp_tools()` from aura.mcp module.
    ...
    if include_mcp:
        try:
            ...
            from aura.mcp.cache import get_cached_mcp_tools
            ...
            if extensions_config.get_enabled_mcp_servers():
                ...
                if mcp_tools:
                    ...
                    if config.tool_search.enabled:
                        from aura.tools.builtins.tool_search import DeferredToolRegistry, set_deferred_registry
                        from aura.tools.builtins.tool_search import tool_search as tool_search_tool
    ...
    try:
        ...
        from aura.tools.builtins.invoke_acp_agent_tool import build_invoke_acp_agent_tool
