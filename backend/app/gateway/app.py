...
API Gateway for Aura - A LangGraph-based AI agent backend with sandbox execution capabilities.
...
This gateway provides custom endpoints for models, MCP configuration, skills, and artifacts.
        ...
        openapi_tags=[
            ...
            {
                "name": "threads",
                "description": "Manage Aura thread-local filesystem data",
            },
            {
                "name": "agents",
    ...
    # CORS is handled by nginx in docker, but we add it here for native desktop mode
    config = get_gateway_config()
    app.add_middleware(
        CORSMiddleware,
    ...
    # Provider API is mounted at /api/provider
    ...
    async def health_check() -> dict:
        ...
        """
        return {"status": "healthy", "service": "aura-gateway"}
