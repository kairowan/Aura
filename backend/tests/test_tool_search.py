...
from aura.tools.builtins.tool_search import (
...
class TestToolSearchTool:
    def test_no_registry(self):
        from aura.tools.builtins.tool_search import tool_search
...
class TestDeferredToolsPromptSection:
    ...
    def _mock_app_config(self, monkeypatch):
        ...
        from aura.config.tool_search_config import ToolSearchConfig

        mock_config = MagicMock()
        mock_config.tool_search = ToolSearchConfig()  # disabled by default
        monkeypatch.setattr("aura.config.get_app_config", lambda: mock_config)

    def test_empty_when_disabled(self):
        from aura.agents.lead_agent.prompt import get_deferred_tools_prompt_section
...
class TestDeferredToolFilterMiddleware:
    ...
    def _ensure_middlewares_package(self):
        ...
        That file replaces aura.agents and aura.agents.middlewares with
        ...
        mock_keys = [
            ...
            "aura.agents.middlewares.deferred_tool_filter_middleware",
        ]
