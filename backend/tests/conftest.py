...
# Make 'app' and 'aura' importable from any working directory
sys.path.insert(0, str(Path(__file__).parent.parent))

# Break the circular import chain that exists in production code:
#   aura.subagents.__init__
#     -> .executor (SubagentExecutor, SubagentResult)
#       -> aura.agents.thread_state
#         -> aura.agents.__init__
#           -> lead_agent.agent
#             -> subagent_limit_middleware
#               -> aura.subagents.executor  <-- circular!
#
# By injecting a mock for aura.subagents.executor *before* any test module
...
sys.modules["aura.subagents.executor"] = _executor_mock
