...
from aura.config.title_config import TitleConfig, get_title_config, set_title_config
...
class TestTitleMiddlewareCoreLogic:
    ...
    def test_generate_title_trims_quotes_and_respects_max_chars(self, monkeypatch):
        ...
        monkeypatch.setattr("aura.agents.middlewares.title_middleware.create_chat_model", lambda **kwargs: fake_model)
    ...
    def test_generate_title_normalizes_structured_message_and_response_content(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "aura.agents.middlewares.title_middleware.create_chat_model",
