...
from aura.skills.loader import get_skills_root_path, load_skills
...
def test_get_skills_root_path_points_to_project_root_skills():
    """get_skills_root_path() should point to aura/skills (sibling of backend/), not backend/packages/skills."""
