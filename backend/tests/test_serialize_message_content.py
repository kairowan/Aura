...
class TestSerializeToolMessageContent:
    """AuraClient._serialize_message should normalize ToolMessage content."""
...
class TestExtractText:
    """AuraClient._extract_text should handle all content shapes."""

    def test_string_passthrough(self):
        assert AuraClient._extract_text("hello") == "hello"

    def test_list_text_blocks(self):
        assert AuraClient._extract_text([{"type": "text", "text": "hi"}]) == "hi"

    def test_empty_list(self):
        assert AuraClient._extract_text([]) == ""

    def test_fallback_non_iterable(self):
        assert AuraClient._extract_text(123) == "123"
