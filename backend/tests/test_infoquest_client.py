...
from aura.community.infoquest import tools
from aura.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("aura.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("aura.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("aura.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/bytedance/python/aurav2/aura/backend/tests/test_infoquest_client.py
