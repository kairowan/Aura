...
from aura.guardrails.provider import GuardrailDecision, GuardrailReason, GuardrailRequest
...
class TestGuardrailMiddleware:
    ...
    def test_protocol_isinstance_check(self):
        ...
        from aura.guardrails.provider import GuardrailProvider
...
class TestGuardrailsConfig:
    def test_config_defaults(self):
        from aura.config.guardrails_config import GuardrailsConfig
    ...
    def test_config_from_dict(self):
        ...
        assert config.provider.use == "aura.guardrails.builtin:AllowlistProvider"
        assert config.provider.config == {"denied_tools": ["bash"]}

    def test_singleton_load_and_get(self):
        from aura.config.guardrails_config import get_guardrails_config, load_guardrails_config_from_dict, reset_guardrails_config
