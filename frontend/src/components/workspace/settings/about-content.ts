 ...
 */
export const aboutMarkdown = `# 💠 [About Aura 2.0](https://github.com/bytedance/aura)
...
* **Skills & Tools**: With built-in and extensible skills and tools, Aura can do almost anything.
...
Visit the official website of Aura: [aura.tech](https://aura.tech/)

## 📧 Support

If you have any questions or need help, please contact us at [support@aura.tech](mailto:support@aura.tech).

---

## 📜 License

Aura is proudly open source and distributed under the **MIT License**.

---

## 🙌 Acknowledgments

We extend our heartfelt gratitude to the open source projects and contributors who have made Aura a reality. We truly stand on the shoulders of giants.
...
These outstanding projects form the backbone of Aura and exemplify the transformative power of open source collaboration.

### Special Thanks
Finally, we want to express our heartfelt gratitude to the core authors of Aura 1.0 and 2.0:

- **[Daniel Walnut](https://github.com/hetaoBackend/)**
- **[Henry Li](https://github.com/magiccube/)**

Without their vision, passion and dedication, \`Aura\` would not be what it is today.
`;
