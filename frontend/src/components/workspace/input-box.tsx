...
export function InputBox({
  ...
  return (
    <div ref={promptRootRef} className="relative">
      <PromptInput
        className={cn(
          "bg-white/40 rounded-2xl backdrop-blur-3xl border border-white/50 shadow-[0_0_60px_rgba(16,185,129,0.1)] ring-1 ring-white/10 transition-all duration-500 ease-out hover:shadow-[0_0_100px_rgba(16,185,129,0.2)] hover:border-white/60 *:data-[slot='input-group']:rounded-2xl animate-aura-breathing",
          className,
        )}
        disabled={disabled}
        globalDrop
      ...
      >
        {extraHeader && (
          <div className="absolute top-0 right-0 left-0 z-10">
            <div className="absolute right-0 bottom-[12px] left-0 flex items-center justify-center">
              {extraHeader}
            </div>
          </div>
        )}
